...
const Features = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        title={pageSEOConfig.features.title}
        description={pageSEOConfig.features.description}
        keywords={pageSEOConfig.features.keywords}
        url="https://expertisestation.com/features"
      />
      <Navbar />
